...
/******/ 	var hotCurrentHash = "8d71829e131a17c3768a"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _glReact = __webpack_require__(159);
	...
	var shaderOrder = ['demo', 'demo2', 'grid', 'grid2'];
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        _reactMotion.Spring,
	        { defaultValue: { val: mouse }, endValue: { val: mouse, config: [140, 12] } },
	        function (_ref) {
	          var _ref$val = _ref.val;
	          var x = _ref$val.x;
	          var y = _ref$val.y;
	          return _react2['default'].createElement(_glReact2['default'].View, {
	            onClick: _this2.onClick,
	            onMouseMove: _this2.onMouseMove,
	            shader: shaders[shaderOrder[_this2.state.shaderIndex]],
	            width: width,
	            height: height,
	            uniforms: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Shaders = __webpack_require__(160);
	var View = __webpack_require__(177);
	var Target = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createShaders = _require.createShaders;

	var checkCompiles = function checkCompiles() {};

	if (process.env.NODE_ENV !== "production") {
	  (function () {
	    var createShader = __webpack_require__(167);
	    var vertexCode = __webpack_require__(176);

	    // Since validation can be intensive, this is only done in dev mode
	    var mockCanvas = document.createElement("canvas");
	    var mockGl = mockCanvas.getContext("webgl") || mockCanvas.getContext("webgl-experimental") || mockCanvas.getContext("experimental-webgl");
	    checkCompiles = function (o) {
	...
	var base = createShaders(function (id, shader) {
	  try {
	    checkCompiles(shader);
	  } catch (e) {
	    var err = new Error("Shader '" + name + "': " + e.message);
	    err.stack = e.stack;
	    err.name = e.name;
	    err.original = e;
	    throw err;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createComponent = __webpack_require__(162);
	var createShaders = __webpack_require__(163);
	var createTarget = __webpack_require__(165);
	var createView = __webpack_require__(166);
	...
	module.exports = function (recordShader) {
	  ...
	  var Shaders = {
	    create: function create(obj) {
	      ...
	      for (var key in obj) {
	        var shader = obj[key];
	        invariant(typeof shader === "object" && typeof shader.frag === "string", "invalid shader given to Shaders.create(). A valid shader is a { frag: String }");
	        var id = _uid++;
	...
	module.exports = function (React) {
	  ...
	  var Target = (function (_Component) {
	    ...
	    function Target() {
	      ...
	      _get(Object.getPrototypeOf(Target.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(Target, [{
	      key: "render",
	      value: function render() {
	        invariant(false, "GL.Target elements are for GL.View configuration only and should not be rendered");
	      }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function textureFromImage(srcOrObj) {
	  if (typeof srcOrObj === "string") srcOrObj = { uri: srcOrObj };
	...
	module.exports = function (React, Shaders, Target, GLComponent, renderVcontainer, renderVtarget, renderVGL) {
	  ...
	  function buildData(shader, uniformsOriginal, width, height, children, targets) {
	    ...
	    var uniforms = {};
	    for (var key in uniformsOriginal) {
	      var value = uniformsOriginal[key];
	      // filter out the texture types...
	      if (value && (typeof value === "string" || typeof value === "object" && !(value instanceof Array))) value = textureFromImage(value);
	      uniforms[key] = value;
	    }
	    ...
	    React.Children.forEach(children, function (child) {
	      ...
	      var uniform = _child$props.uniform;
	      ...
	      var onlyChild = reactFirstChildOnly(children);
	      if (onlyChild) {
	        if (!React.isValidElement(onlyChild)) {
	          data.uniforms[uniform] = textureFromImage(onlyChild);
	          return;
	        } else {
	          var childGLView = undefined;
	          ...
	          if (childGLView) {
	            var _id = data.children.length;
	            var _childGLView$props = childGLView.props;
	            var _shader = _childGLView$props.shader;
	            var _uniforms = _childGLView$props.uniforms;
	            var _children = _childGLView$props.children;

	            var dataChild = buildData(_shader, _uniforms, width, height, _children, targets);
	            data.children.push(dataChild);
	            data.uniforms[uniform] = textureFromFramebuffer(_id);
	            return;
	          }
	        }
	      }
	  ...
	  var GLView = (function (_Component) {
	    _inherits(GLView, _Component);

	    function GLView(props, context) {
	      _classCallCheck(this, GLView);

	      _get(Object.getPrototypeOf(GLView.prototype), "constructor", this).call(this, props, context);
	      this._renderId = 1;
	    }
	    ...
	    _createClass(GLView, [{
	      ...
	      value: function render() {
	        ...
	        var targets = [];
	        var data = buildData(shader, uniforms, width, height, children, targets);

	        return renderVcontainer(style, width, height, targets, renderVGL(cleanedProps, width, height, data, targets.length, renderId));
	      }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createUniformWrapper = __webpack_require__(168);
	var createAttributeWrapper = __webpack_require__(170);
	var makeReflect = __webpack_require__(169);
	var shaderCache = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var coallesceUniforms = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var weakMap = typeof WeakMap === 'undefined' ? __webpack_require__(172) : WeakMap;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hiddenStore = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Target = __webpack_require__(178);
	var Component = __webpack_require__(179);
	var GLCanvas = __webpack_require__(180);

	var _require = __webpack_require__(161);

	var createView = _require.createView;

	var renderVtarget = function renderVtarget(style, width, height, id, children) {
	  ...
	  return React.createElement(
	    "div",
	    { key: "target-" + id, style: _extends({}, childrenStyle, style) },
	    target
	  );
	};

	var renderVGL = function renderVGL(props, width, height, data, nbTargets) {
	  return React.createElement(GLCanvas, _extends({}, props, {
	    width: width,
	    height: height,
	    data: data,
	    nbTargets: nbTargets
	...
	var renderVcontainer = function renderVcontainer(style, width, height, targets, renderer) {
	  var parentStyle = _extends({}, style, {
	    position: "relative",
	    width: width + "px",
	    height: height + "px",
	    overflow: "hidden"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createTarget = _require.createTarget;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createComponent = _require.createComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createShader = __webpack_require__(167);
	var createTexture = __webpack_require__(181);
	var createFBO = __webpack_require__(197);
	var Shaders = __webpack_require__(160);
	var GLImage = __webpack_require__(198);
	var vertShader = __webpack_require__(176);
	...
	var GLCanvas = (function (_Component) {
	  ...
	  function GLCanvas(props) {
	    ...
	    _get(Object.getPrototypeOf(GLCanvas.prototype), "constructor", this).call(this, props);
	    this.state = {
	  ...
	  _createClass(GLCanvas, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement("canvas", _extends({}, this.props, {
	        data: undefined,
	        ref: "render",
	        style: styles,
	        width: width * scale,
	    ...
	    value: function componentDidMount() {
	      ...
	      var canvas = React.findDOMNode(this.refs.render);
	      var opts = {};
	      var gl = canvas.getContext("webgl", opts) || canvas.getContext("webgl-experimental", opts) || canvas.getContext("experimental-webgl", opts);
	      if (!gl) return;
	      this.gl = gl;
	    ...
	    value: function componentWillUnmount() {
	      ...
	      this._targetTextures.forEach(function (t) {
	        return t.dispose();
	      });
	    ...
	    value: function componentWillReceiveProps(props) {
	      ...
	      if (this.state.devicePixelRatio !== devicePixelRatio) {
	        this.setState({ devicePixelRatio: devicePixelRatio });
	      }
	      if (props.opaque !== this.props.opaque) this.syncBlendMode(props);
	      if (props.nbTargets !== this.props.nbTargets) this.resizeTargetTextures(props.nbTargets);
	    }
	  }, {
	    ...
	    key: "syncData",
	    value: function syncData(data) {
	      // Synchronize the data props that contains every data needed for render
	      var gl = this.gl;
	      if (!gl) return;

	      var onImageLoad = this.onImageLoad;
	      var targetTextures = this._targetTextures;

	      // old values
	      var prevShaders = this._shaders;
	      var prevImages = this._images;
	      var prevFbos = this._fbos; // FBO is short for "framebuffer object"

	      // new values (mutated from traverseTree)
	      var shaders = {}; // shaders cache (per Shader ID)
	      var images = {}; // images cache (per src)
	      var fbos = {}; // pool of FBOs (the size is determined by the pass children max length)
	      ...
	      function traverseTree(data, frameIndex) {
	        ...
	        for (var uniformName in dataUniforms) {
	          ...
	          if (value && (type === "sampler2D" || type === "samplerCube")) {
	            ...
	            switch (value.type) {
	              case "target":
	                // targets are DOM elements that can be rendered as texture (<canvas>, <img>, <video>)
	                textures[uniformName] = targetTextures[value.id];
	                break;

	              case "framebuffer":
	                // framebuffers are a children rendering
	                var id = fbosMapping[value.id]; // value.id is child index, we obtain the fbo index (via fbosMapping)
	                var fbo = undefined;
	                if (id in fbos) {
	        ...
	        return { shader: shader, uniforms: uniforms, textures: textures, children: children, width: width, height: height, frameIndex: frameIndex };
	      }
	    ...
	    value: function draw() {
	      ...
	      function recDraw(renderData) {
	        ...
	        var frameIndex = renderData.frameIndex;
	    ...
	    key: "resizeTargetTextures",
	    value: function resizeTargetTextures(n) {
	      var gl = this.gl;
	      var targetTextures = this._targetTextures;
	      var length = targetTextures.length;
	      if (length === n) return;
	      if (n < length) {
	        ...
	        for (var i = targetTextures.length; i < n; i++) {
	    ...
	    key: "syncTargetTextures",
	    value: function syncTargetTextures() {
	      var targets = this.getDrawingTargets();
	      var targetTextures = this._targetTextures;
	    ...
	    key: "syncTargetTexture",
	    value: function syncTargetTexture(texture, target) {
	      var width = target.width || target.videoWidth;
	      var height = target.height || target.videoHeight;
	      if (width && height) {
	    ...
	    key: "syncBlendMode",
	    value: function syncBlendMode(props) {
	      var gl = this.gl;
	      if (!gl) return;
	      if (props.opaque) {
	        gl.disable(gl.BLEND);
	    ...
	    key: "getDrawingTargets",
	    value: function getDrawingTargets() {
	      var nbTargets = this.props.nbTargets;

	      if (nbTargets === 0) return [];
	      var children = React.findDOMNode(this.refs.render).parentNode.children;
	      var all = [];
	    ...
	    key: "requestSyncData",
	    value: function requestSyncData() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ops = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var iota = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compile = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createThunk = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compile = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bits = __webpack_require__(195);
	var dup = __webpack_require__(196);
	  ...
	  reloadImage: function reloadImage() {
	    ...
	    if (!src) {
	      ...
	      this._loading = loadImage(src, function (img) {
	        ...
	        _this._loading = null;
	        _this.image = img;
	        if (_this._onload) _this._onload();
	      }, function () {
	        _this._loading = null;
	        _this.clearImage();
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _presets2 = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapTree = __webpack_require__(203);
	...
	var _compareTrees = __webpack_require__(210);
	...
	var _zero = __webpack_require__(215);

	var _zero2 = _interopRequireDefault(_zero);

	var _updateTree = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashIsplainobject = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(213),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(217);
	...
	var _presets = __webpack_require__(218);
